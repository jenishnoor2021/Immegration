            ...
            <div class="box">
               ...
               <div class="row">
                  <div class="col-md-9">
                     ...
                     <button style="padding:10px 20px;margin-left:10px;" class="btn btn-danger text-white delete_all" data-url="{{ route('admin.branch.deleteAll') }}"><i class="fa fa-trash"></i> Delete Selected</button>
                  </div>
               </div>
               <!-- /.box-header -->
