      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide">
            <div class="wptb-slider--item">
               <div class="wptb-slider--image" style="background-image: url('{{ asset('assets/img/slider/6.jpg') }}');"></div>
               <div class="container">
                  <div class="row">
                     <!-- Content Column -->
                     <div class="col-lg-12">
         ...
         <div class="swiper-slide">
            <div class="wptb-slider--item">
               <div class="wptb-slider--image" style="background-image: url('{{ asset('assets/img/slider/7.jpg') }}');"></div>
               <div class="container">
                  <div class="row">
                     <!-- Content Column -->
         ...
         <div class="swiper-slide">
            <div class="wptb-slider--item">
               <div class="wptb-slider--image" style="background-image: url('{{ asset('assets/img/slider/8.jpg') }}');"></div>
               <div class="container">
                  <div class="row">
                     <!-- Content Column -->
                     <div class="col-xxl-7 col-lg-6 col-md-10 col-sm-12">
         ...
         <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
               <div class="wptb-image-box1 wow fadeInLeft">
                  <div class="wptb-item--inner">
                     <div class="wptb-item--image">
                        <a href="{{URL::to('/services')}}" class="wptb-item-link"><img src="{{asset('assets/img/services/2.jpg')}}" alt="img"></a>
                     </div>
                     <div class="wptb-item--holder">
                        <div class="wptb-item--icon">
                           <svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 9 9" fill="none">
                        ...
                        <h4 class="wptb-item--title"><a href="{{URL::to('/services')}}">Green Card Application</a></h4>
                        <div class="wptb-line-paper"></div>
            ...
            <div class="swiper-slide">
               <div class="wptb-image-box1 wow fadeInLeft">
                  <div class="wptb-item--inner">
                     <div class="wptb-item--image">
                        <a href="{{URL::to('/services')}}" class="wptb-item-link"><img src="{{asset('assets/img/services/3.jpg')}}" alt="img"></a>
                     </div>
                     <div class="wptb-item--holder">
                        <div class="wptb-item--icon">
                           <svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 9 9" fill="none">
                        ...
                        <h4 class="wptb-item--title"><a href="{{URL::to('/services')}}">Student Visa Processing</a></h4>
                        <div class="wptb-line-paper"></div>
...
<section class="wptb-why-choose-three bg-image" style="background-image: url('{{ asset('assets/img/background/bg-14.jpg') }}');">
   <div class="container">
      <div class="wptb-heading">
         <div class="wptb-item--inner text-center">
            <h6 class="wptb-item--subtitle">
...
<div class="wptb-video-player1 wow zoomIn">
   <div class="wptb-item--inner">
      <div class="wptb-item--holder">
         <div class="wptb-item--image">
            <img src="{{asset('assets/img/background/bg-5.jpg')}}" alt="img">
         </div>
         <div class="wptb-item--button">
         ...
         <div class="row">
            <div class="col-md-6">
               <div class="wptb-accordion wptb-accordion1 wow fadeInUp">
                  ...
                  <div class="wptb--item">
                     <h6 class="wptb-item-title"><span>Q2. What are the contact address of Seven Countries?</span> <i class="bi bi-chevron-down"></i></h6>
                     <div class="wptb-item--content">
                        Our business consulting programs helps to break the performance of your business down into customers and product groups so you know exactly which customers or product groups are working.
                     </div>
                  </div>
                     ...
                     <form method="post" action="/appointmentstore" id="appointment_form" class="wptb-form" name="appointment_form">
                        ...
                        <div class="wptb-form--inner">
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-6 col-lg-6 mb-4">
                                 <div class="form-group">
                                    <input type="text" name="s_date" class="flatpickr form-control" placeholder="Select Date" required>
                                 </div>
                              </div>

                              <div class="col-md-6 col-lg-6 mb-4">
                                 <div class="form-group">
                                    <input type="text" name="time" class="flatpickr-time form-control" placeholder="Select Time" required>
                                 </div>
                              </div>

                              <div class="col-md-12 col-lg-12">
                                 <div class="wptb-item--button text-center">
                                    <button class="btn" type="submit" id="submitButton"><span>Contact Us</span></button>
...
<section class="wptb-faq-two p-0">
   <div class="wptb-image-single position-absolute start-0 top-0 bottom-0 d-none d-lg-block wow skewIn">
      <div class="wptb-item--inner h-100">
         <div class="wptb-item--image h-100">
            <img src="{{asset('assets/img/2.jpg')}}" alt="img" class="h-100">
         </div>
      </div>
   </div>
               ...
               <div class="tab-content">
                     ...
                     <div class="wptb-tab-content">
                        <div class="wptb-tab-content--holder">
                           <div class="wptb-tab-content--icon">
                              <img src="{{asset('assets/img/clients/hc-logo1.png')}}" alt="icon">
                           </div>
                           <h3 class="wptb-tab-content--title">Committed to provide you best services</h3>
                           <p class="wptb-tab-content--description"> Seven Countries Visa Consultancy travel created to provide uniquely designed premium services in the world of</p>
                           <div class="wptb-item--button">
                              <a class="btn--readmore" href="{{URL::to('/contactus')}}">
                  ...
                  <div class="tab-pane fade" id="tab-two" role="tabpanel">
                     <div class="wptb-tab-content">
                        <div class="wptb-tab-content--holder">
                           <div class="wptb-tab-content--icon">
                              <img src="{{asset('assets/img/clients/hc-logo2.png')}}" alt="icon">
                           </div>
                           <h3 class="wptb-tab-content--title">Committed to provide you best services</h3>
                           <p class="wptb-tab-content--description"> Seven Countries Visa Consultancy travel created to provide uniquely designed premium services in the world of</p>
                           <div class="wptb-item--button">
                  ...
                  <div class="tab-pane fade" id="tab-three" role="tabpanel">
                     <div class="wptb-tab-content">
                        <div class="wptb-tab-content--holder">
                           <div class="wptb-tab-content--icon">
                              <img src="{{asset('assets/img/clients/hc-logo3.png')}}" alt="icon">
                           </div>
                           <h3 class="wptb-tab-content--title">Committed to provide you best services</h3>
                           <p class="wptb-tab-content--description"> Seven Countries Visa Consultancy travel created to provide uniquely designed premium services in the world of</p>
                           <div class="wptb-item--button">
                  ...
                  <div class="tab-pane fade" id="tab-four" role="tabpanel">
                     <div class="wptb-tab-content">
                        <div class="wptb-tab-content--holder">
                           <div class="wptb-tab-content--icon">
                              <img src="{{asset('assets/img/clients/hc-logo4.png')}}" alt="icon">
                           </div>
                           <h3 class="wptb-tab-content--title">Committed to provide you best services</h3>
                           <p class="wptb-tab-content--description"> Seven Countries Visa Consultancy travel created to provide uniquely designed premium services in the world of</p>
                           <div class="wptb-item--button">
            ...
            <div class="wptb-item--right">
               <ul class="wptb-item--holder" id="pills-tab" role="tablist">
                  <li class="wptb-item--title">
                     <a class="wptb-item--link active" href="#tab-one" data-bs-toggle="tab" role="tab"><i class="bi bi-arrow-right"></i> Canada Council</a>
                  </li>
                  <li class="wptb-item--title">
   ...
   <div class="wptb-image-single position-absolute end-0 top-0 bottom-0 wow skewIn">
      <div class="wptb-item--inner">
         <div class="wptb-item--image">
            <img src="{{asset('assets/img/vector-1.png')}}" alt="img">
         </div>
      </div>
   </div>
</section>
         ...
         <div class="swiper-wrapper">
            <div class="swiper-slide">
               <div class="wptb-partner--image1">
                  <a href="#">
                     <img src="{{asset('assets/img/clients/logo-01.png')}}" alt="" class="img-fluid">
                     <img src="{{asset('assets/img/clients/logo-01.png')}}" alt="" class="img-fluid">
                  </a>
               </div>
            </div>
            ...
            <div class="swiper-slide">
               <div class="wptb-partner--image1">
                  <a href="#">
                     <img src="{{asset('assets/img/clients/logo-02.png')}}" alt="" class="img-fluid">
                     <img src="{{asset('assets/img/clients/logo-02.png')}}" alt="" class="img-fluid">
                  </a>
               </div>
            </div>
            ...
            <div class="swiper-slide">
               <div class="wptb-partner--image1">
                  <a href="#">
                     <img src="{{asset('assets/img/clients/logo-03.png')}}" alt="" class="img-fluid">
                     <img src="{{asset('assets/img/clients/logo-03.png')}}" alt="" class="img-fluid">
                  </a>
               </div>
            </div>
            ...
            <div class="swiper-slide">
               <div class="wptb-partner--image1">
                  <a href="#">
                     <img src="{{asset('assets/img/clients/logo-04.png')}}" alt="" class="img-fluid">
                     <img src="{{asset('assets/img/clients/logo-04.png')}}" alt="" class="img-fluid">
                  </a>
               </div>
            </div>
            ...
            <div class="swiper-slide">
               <div class="wptb-partner--image1">
                  <a href="#">
                     <img src="{{asset('assets/img/clients/logo-05.png')}}" alt="" class="img-fluid">
                     <img src="{{asset('assets/img/clients/logo-05.png')}}" alt="" class="img-fluid">
                  </a>
               </div>
            </div>
            ...
            <div class="swiper-slide">
               <div class="wptb-partner--image1">
                  <a href="#">
                     <img src="{{asset('assets/img/clients/logo-06.png')}}" alt="" class="img-fluid">
                     <img src="{{asset('assets/img/clients/logo-06.png')}}" alt="" class="img-fluid">
                  </a>
               </div>
            </div>
...
<script>
   ...
   document.getElementById('appointment_form').addEventListener('submit', function() {
