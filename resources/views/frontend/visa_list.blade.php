         ...
         <div class="swiper-wrapper">
               ...
               <div class="wptb-image-box3 wow fadeInLeft">
                  <div class="wptb-item--inner">
                     <div class="wptb-item--image">
                        <img src="{{asset('assets/img/services/4.jpg')}}" alt="img">
                        <div class="wptb-item--button"> <a class="btn--readmore" href="{{URL::to('/services')}}"> <span class="btn-readmore--icon"> <i class="bi bi-arrow-right"></i> </span> </a></div>
                     </div>
                     <div class="wptb-item--holder">
                        <div class="wptb-item--icon">
                           <img src="{{asset('assets/img/services/icon-8.png')}}" alt="icon">
                        </div>
                        <div class="wptb-item--wrap-content">
                           <p class="wptb-item--description"> Service 1</p>
                           <h4 class="wptb-item--title"><a href="{{URL::to('/services')}}">Tourist Visa</a></h4>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="swiper-slide">
               <div class="wptb-image-box3 wow fadeInLeft">
                  <div class="wptb-item--inner">
                     <div class="wptb-item--image">
                        <img src="{{asset('assets/img/services/5.jpg')}}" alt="img">
                        <div class="wptb-item--button"> <a class="btn--readmore" href="{{URL::to('/services')}}"> <span class="btn-readmore--icon"> <i class="bi bi-arrow-right"></i> </span> </a></div>
                     </div>
                     <div class="wptb-item--holder">
                        <div class="wptb-item--icon">
                           <img src="{{asset('assets/img/services/icon-9.png')}}" alt="icon">
                        </div>
                        <div class="wptb-item--wrap-content">
                           <p class="wptb-item--description"> Service 2</p>
                           <h4 class="wptb-item--title"><a href="{{URL::to('/services')}}">Student Visa</a></h4>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="swiper-slide">
               <div class="wptb-image-box3 wow fadeInLeft">
                  <div class="wptb-item--inner">
                     <div class="wptb-item--image">
                        <img src="{{asset('assets/img/services/6.jpg')}}" alt="img">
                        <div class="wptb-item--button"> <a class="btn--readmore" href="{{URL::to('/services')}}"> <span class="btn-readmore--icon"> <i class="bi bi-arrow-right"></i> </span> </a></div>
                     </div>
                     <div class="wptb-item--holder">
                        <div class="wptb-item--icon">
                           <img src="{{asset('assets/img/services/icon-10.png')}}" alt="icon">
                        </div>
                        <div class="wptb-item--wrap-content">
                           <p class="wptb-item--description"> Service 3</p>
                           <h4 class="wptb-item--title"><a href="{{URL::to('/services')}}">Family Visa</a></h4>
                        </div>
                     </div>
                  </div>
               </div>
