...
<div class="page-content contact-us-page">
	...
	<section class="site-content countries-pagess pbmit-portfolio-single">
		...
		'image' => 'page/europe/header-europe.png',
		'alt' => 'Europe immigration and education'
		])
						...
						<div class="pbmit-entry-content">
							...
							<div class="why-usa-section-card text-left" id="whyChooseUSACard">
								...
								<div class="why-usa-text-col">
									...
									<!-- Heading -->
									<h2 class="why-usa-title">Why Choose Europe?</h2>
									...
									<p class="why-usa-desc">
										World-class education, rich history, diverse cultures, stunning landscapes and excellent career opportunities make Europe a top choice for students, travelers and families.
									...
									<div class="polaroid-gallery-wrapper">
										...
										<div class="polaroid-card card-san-francisco">
											...
											<div class="polaroid-photo">
												<img src="{{ asset('website-static/images') }}/page/europe/choose-europe-1.jpg" alt="Dream" loading="lazy">
											</div>
										...
										<div class="polaroid-card card-new-york">
											<div class="polaroid-photo">
												<img src="{{ asset('website-static/images') }}/page/europe/choose-europe-2.jpg" alt="Explore" loading="lazy">
											</div>
										...
										<div class="polaroid-card card-las-vegas">
											<div class="polaroid-photo">
												<img src="{{ asset('website-static/images') }}/page/europe/choose-europe-3.jpg" alt="Archive" loading="lazy">
											</div>
		...
		<div class="choose-visa-page">
			<div class="container">
				<h2 class="section-title">Choose Your Europe Visa</h2>
				<p class="section-subtitle">We offer a range of visa options to help you achieve your European dream.</p>
				...
				<div class="cards-grid">
					...
					<div class="card card-blue">
						...
						<h3 class="card-title">Europe Student Visa</h3>
						<p class="card-description">Study at top-ranked universities and build your future.</p>
					...
					<div class="card card-red">
						...
						<h3 class="card-title">Europe Tourist Visa</h3>
						<p class="card-description">Explore iconic cities, charming towns and beautiful landscapes.</p>
						<a href="#" class="learn-more">Learn More &rarr;</a>
					</div>
					...
					<div class="card card-green">
						...
						<h3 class="card-title">Europe Visitor Visa</h3>
					...
					<div class="card card-purple">
						...
						<h3 class="card-title">Europe Spouse Visa</h3>
						<p class="card-description">Join your spouse in Europe.</p>
						<a href="#" class="learn-more">Learn More &rarr;</a>
					</div>
					...
					<div class="card card-orange">
						...
						<h3 class="card-title">Europe Business Visa</h3>
						<p class="card-description">Travel for business meetings and opportunities.</p>
						<a href="#" class="learn-more">Learn More &rarr;</a>
					</div>
				</div>
			</div>
		...
		<div class="explore-city europe-city-list">
			<!-- Header Section -->
			<div class="container all-cities-title">
				<h2 class="section-title">Explore Popular European Countries</h2>
				<p class="section-subtitle">Discover vibrant cities, historic landmarks and unique experiences across Europe.</p>
			</div>
			`
				...
				<div class="cities-grid">
					...
					<article class="city-card">
						<div class="card-image-wrapper">
							<img class="card-image" src="{{ asset('website-static/images') }}/page/europe/city-europe-1.jpg" alt="Auckland" loading="lazy">
						</div>
						<div class="card-content">
							<h2 class="city-name">France</h2>
							<p class="city-description">Iconic landmarks, art, fashion and a rich cultural heritage.</p>
						</div>
					</article>
					...
					<article class="city-card">
						<div class="card-image-wrapper">
							<img class="card-image" src="{{ asset('website-static/images') }}/page/europe/city-europe-2.jpg" alt="Wellington" loading="lazy">
						</div>
						<div class="card-content">
							<h2 class="city-name">Russia</h2>
							<p class="city-description">Modern cities, historic castles and world-class education.</p>
						</div>
					</article>
					...
					<article class="city-card">
						<div class="card-image-wrapper">
							<img class="card-image" src="{{ asset('website-static/images') }}/page/europe/city-europe-3.jpg" alt="Christchurch" loading="lazy">
						</div>
						<div class="card-content">
							<h2 class="city-name">Italy</h2>
							<p class="city-description">Ancient history, art, food and unforgettable experiences.</p>
						</div>
					</article>
					...
					<article class="city-card">
						<div class="card-image-wrapper">
							<img class="card-image" src="{{ asset('website-static/images') }}/page/europe/city-europe-4.jpg" alt="Queenstown" loading="lazy">
						</div>
						<div class="card-content">
							<h2 class="city-name">Spain</h2>
							<p class="city-description">Vibrant culture, sunny beaches and historic cities.</p>
						</div>
					</article>
					...
					<article class="city-card">
						<div class="card-image-wrapper">
							<img class="card-image" src="{{ asset('website-static/images') }}/page/europe/city-europe-5.jpg" alt="Rotorua" loading="lazy">
						</div>
						<div class="card-content">
							<h2 class="city-name">Netherlands</h2>
							<p class="city-description">Picturesque cities, innovative education and friendly lifestyle.</p>
						</div>
					</article>
					...
					<article class="city-card">
						<div class="card-image-wrapper">
							<img class="card-image" src="{{ asset('website-static/images') }}/page/europe/city-europe-6.jpg" alt="Rotorua" loading="lazy">
						</div>
						<div class="card-content">
							<h2 class="city-name">Switzerland</h2>
							<p class="city-description">Breathtaking nature, quality education and high living standards.</p>
						</div>
					</article>
		...
		<div class="container-fluid">
			<div class="uk-visa-journey-card" id="visaJourneyComponent">
				...
				<div class="uk-journey-visual-panel">
					<img src="{{ asset('website-static/images') }}/page/europe/why-europe.png" />
				...
				<div class="uk-journey-content-panel">
					...
					<div class="guidance-step-item">
						...
						<div class="guidance-step-text">
							...
							<p class="guidance-desc">We evaluate your profile and goals.</p>
						</div>
					</div>
					...
					<div class="guidance-step-item">
						...
						<div class="guidance-step-text">
							...
							<p class="guidance-desc">Get travel tips for a smooth journey to Europe.</p>
						</div>
					</div>
		...
		<div class="container-fluid">
			<div class="destination-section europe-map-banner where-to-go germany-map">

				<section class="map-banner">
					<div class="map-container">

						<!-- SVG Stylized UK Map Vector -->
						<img src="{{ asset('website-static/images') }}/page/europe/europe-map.png" />
				...
				<section class="cards-grid">
					...
					<article class="card">
						<div class="card-image-box">
							<img src="{{ asset('website-static/images') }}/page/europe/germany.jpg" alt="France">
						</div>
						<div class="card-label label-england">France</div>
						<div class="card-body">
							<ul class="city-list">
								<li>Paris</li>
								<li>Nice</li>
					...
					<article class="card">
						<div class="card-image-box">
							<img src="{{ asset('website-static/images') }}/page/europe/russia.jpg" alt="Germany">
						</div>
						<div class="card-label label-scotland">Russia</div>
						<div class="card-body">
							<ul class="city-list">
								<li>Moscow</li>
								<li>Kazan</li>
					...
					<article class="card">
						<div class="card-image-box">
							<img src="{{ asset('website-static/images') }}/page/europe/italy.jpg" alt="Italy">
						</div>
						<div class="card-label label-wales">Italy</div>
						<div class="card-body">
							<ul class="city-list">
								<li>Rome</li>
								<li>Milan</li>
					...
					<article class="card">
						<div class="card-image-box">
							<img src="{{ asset('website-static/images') }}/page/europe/spain.jpg" alt="Spain">
						</div>
						<div class="card-label label-ni">Spain</div>
						<div class="card-body">
							<ul class="city-list">
								<li>Barcelona</li>
								<li>Madrid</li>
					...
					<article class="card">
						<div class="card-image-box">
							<img src="{{ asset('website-static/images') }}/page/europe/netherland.jpg" alt="Netherlands">
						</div>
						<div class="card-label label-ni">Netherlands</div>
						<div class="card-body">
							<ul class="city-list">
								<li>Amsterdam</li>
								<li>Rotterdam</li>
					...
					<article class="card">
						<div class="card-image-box">
							<img src="{{ asset('website-static/images') }}/page/europe/switzerland.jpg" alt="Switzerland">
						</div>
						<div class="card-label label-ni">Switzerland</div>
						<div class="card-body">
							<ul class="city-list">
								<li>Zurich</li>
								<li>Geneva</li>
		...
		<div class="container-fluid europe-journey">
			<section class="res-journey-img">
				<img src="{{ asset('website-static/images') }}/page/europe/footer-europe.png" />
			</section>
