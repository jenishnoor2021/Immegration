...
(function ($) {
    ...
    $(".county_list li").on('click', function() {
        var dataCountry = $(this).data("country");
        $(this).addClass("active").siblings().removeClass("active");
        $(".country_content .blog-details-inner").hide();
        $(".country_content .blog-details-inner[data-country='" + dataCountry + "']").show();
    });

    $(".visa_list li").on('click', function() {
        var dataVisa = $(this).data("visa");
        $(this).addClass("active").siblings().removeClass("active");
